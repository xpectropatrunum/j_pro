...
class LetterSubjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (auth()->user()->hasRole("admin")) {
            $query = LetterSubject::latest();
        } else {
            $query = auth()->user()->letter_subjects()->latest();
        }
        ...
        return view('admin.pages.letter_subjects.index', compact('items', 'search', 'limit'));
    }
    ...
    public function destroy(LetterSubject $letterSubject)
    {
        if ($letterSubject->delete()) {
